...
modules/shape/test_precomp.hpp.gch/opencv_test_shape_Release.gch: C:/opencv/sources/modules/shape/test/test_precomp.hpp
...
modules/shape/test_precomp.hpp.gch/opencv_test_shape_Release.gch: lib/libopencv_test_shape_pch_dephelp.a
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=C:\opencv\mingw-build\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating test_precomp.hpp.gch/opencv_test_shape_Release.gch"
	cd /d C:\opencv\mingw-build\modules\shape && C:\cmake-3.7.2\bin\cmake.exe -E make_directory C:/opencv/mingw-build/modules/shape/test_precomp.hpp.gch
	cd /d C:\opencv\mingw-build\modules\shape && "C:\Program Files (x86)\TDM-GCC\bin\g++.exe" -O3 -DNDEBUG -DNDEBUG "-D__OPENCV_BUILD=1" "-D_USE_MATH_DEFINES" "-D__STDC_CONSTANT_MACROS" "-D__STDC_LIMIT_MACROS" "-D__STDC_FORMAT_MACROS" "-D__OPENCV_TESTS=1" -std=c++11 -isystem"C:/opencv/mingw-build" -isystem"C:/opencv/mingw-build" -I"C:/opencv/sources/modules/ts/include" -I"C:/opencv/sources/modules/shape/include" -I"C:/opencv/sources/modules/imgcodecs/include" -I"C:/opencv/sources/modules/videoio/include" -I"C:/opencv/sources/modules/core/include" -I"C:/opencv/sources/modules/imgproc/include" -I"C:/opencv/sources/modules/video/include" -I"C:/opencv/sources/modules/core/include" -I"C:/opencv/sources/modules/imgproc/include" -I"C:/opencv/sources/modules/imgcodecs/include" -I"C:/opencv/sources/modules/videoio/include" -I"C:/opencv/sources/modules/highgui/include" -I"C:/opencv/sources/modules/shape/test" -fsigned-char -W -Wall -Werror=return-type -Werror=non-virtual-dtor -Werror=address -Werror=sequence-point -Wformat -Werror=format-security -Wmissing-declarations -Wundef -Winit-self -Wpointer-arith -Wshadow -Wsign-promo -Wuninitialized -Winit-self -Wno-narrowing -Wno-delete-non-virtual-dtor -Wno-comment -fdiagnostics-show-option -Wno-long-long -fomit-frame-pointer -ffunction-sections -fdata-sections -msse -msse2 -msse3 -fvisibility=hidden -fvisibility-inlines-hidden -x c++-header -o C:/opencv/mingw-build/modules/shape/test_precomp.hpp.gch/opencv_test_shape_Release.gch C:/opencv/mingw-build/modules/shape/test_precomp.hpp

modules/shape/test_precomp.hpp: C:/opencv/sources/modules/shape/test/test_precomp.hpp
	...
	cd /d C:\opencv\mingw-build\modules\shape && C:\cmake-3.7.2\bin\cmake.exe -E copy_if_different C:/opencv/sources/modules/shape/test/test_precomp.hpp C:/opencv/mingw-build/modules/shape/test_precomp.hpp
...
modules/shape/CMakeFiles/pch_Generate_opencv_test_shape.dir/clean:
	cd /d C:\opencv\mingw-build\modules\shape && $(CMAKE_COMMAND) -P CMakeFiles\pch_Generate_opencv_test_shape.dir\cmake_clean.cmake
...
modules/shape/CMakeFiles/pch_Generate_opencv_test_shape.dir/depend:
	$(CMAKE_COMMAND) -E cmake_depends "MinGW Makefiles" C:\opencv\sources C:\opencv\sources\modules\shape C:\opencv\mingw-build C:\opencv\mingw-build\modules\shape C:\opencv\mingw-build\modules\shape\CMakeFiles\pch_Generate_opencv_test_shape.dir\DependInfo.cmake --color=$(COLOR)
